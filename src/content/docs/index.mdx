...
large histories — and it covers every
[agent AgentsView supports](/configuration/#session-discovery),
...
<CardGrid stagger>
  ...
  <Card title="Token Usage & Costs" icon="seti:db">
    ...
    daily spend reports and a today's-cost status line. Drop-in
    alternative to `ccusage` that covers every supported agent
    and runs 80–220× faster on large session histories.
  </Card>
