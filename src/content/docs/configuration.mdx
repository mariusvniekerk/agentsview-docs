...
| `proxy` | Managed proxy configuration object — see [Remote Access](/remote-access/) |
...
agentsview auto-discovers session files from twelve agent types:
