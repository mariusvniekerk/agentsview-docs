...
The 0.21.0 release adds a dedicated **Usage** page to the web
UI, reachable from the **Usage** button in the header or
directly at `/usage`. It's a focused view of cost and token
totals, driven by the same data the CLI commands read.
