...
![Grade badge in the session header](/screenshots/grade-badge.png)
...
![Signal panel with basis tags, compaction chip, and penalty chips](/screenshots/signal-panel.png)
...
![Session Health section on the analytics dashboard](/screenshots/session-health.png)
